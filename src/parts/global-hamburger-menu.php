<div aria-hidden="true" id="hamburger-menu" class="global-hamburger-menu js-global-hamburger-menu">
  <nav>
    <ul class="global-hamburger-menu__list">
      ...
      <li class="global-hamburger-menu__item"><a href="<?= URL_ARCHIVE ?>">ARCHIVE</a></li>
      <li class="global-hamburger-menu__item"><a href="<?= URL_PRIVACY ?>">PRIVACY</a></li>
      <li class="global-hamburger-menu__item"><a href="<?= URL_CONTACT ?>" target="_blank" rel="noopener noreferrer">CONTACT</a></li>
    </ul>
  </nav>
</div>